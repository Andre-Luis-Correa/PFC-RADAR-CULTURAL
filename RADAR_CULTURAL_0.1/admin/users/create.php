                ...
                <div class="content">
                    ...
                    <form action="create.php" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input type="text" name="nome_usuario" value="<?php //echo $username; ?>" class="text-input">
                        </div>
                        <div>
                            <label>Email</label>
                        ...
                        <div>
                            <label>Senha</label>
                            <input type="password" name="senha" value="<?php //echo $password; ?>" class="text-input">
                        </div>
                        <div>
                            <label>Confirmação de senha</label>
                            <input type="password" name="senhaConf" value="<?php //echo $passwordConf; ?>" class="text-input">
                        </div>
                        <div>
                        ...
                        <div>
                            <?php if (isset($colaborador) && $colaborador == 2): ?>
                                <label>
