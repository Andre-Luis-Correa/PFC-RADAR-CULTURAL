                        ...
                        <tbody>
                            <?php foreach ($pages as $key => $page): ?>
                               <tr>
                                    ...
                                    <td><a href="edit.php?id_pagina=<?php echo $page['id_pagina']; ?>" class="edit"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                    width="24" height="24"
                                    viewBox="0 0 172 172"
                                    ...
                                    <td><a href="index.php?del_id=<?php echo $page['id_pagina']; ?>" class="delete"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                    width="24" height="24"
                                    viewBox="0 0 172 172"
